...
if [ $POWERLINE_TERRAFORM_WORKSPACE != "" ]; then
    TERRAFORM_WORKSPACE_PROMPT=" $(tf_prompt_info)"
fi

PROMPT="
$POWERLINE_SEC1_BG$POWERLINE_SEC1_TXT $POWERLINE_USER_NAME $VENV_STATUS%k%f$POWERLINE_SEC1_FG%K{blue}"$'\ue0b0'"%k%f%F{white}%K{blue} "$POWERLINE_PATH"%F{blue}"$POWERLINE_GIT_INFO_LEFT" %k"$'\ue0b0'"%f$TERRAFORM_WORKSPACE_PROMPT
%k"$'\ue0b0'"%f "
